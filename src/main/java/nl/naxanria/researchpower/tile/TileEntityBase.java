...
import nl.naxanria.researchpower.network.PacketServerToClient;
import nl.naxanria.researchpower.util.ModUtil;
import nl.naxanria.researchpower.util.WorldUtil;
...
public abstract class TileEntityBase extends TileEntity implements ITickable
{
  ...
  public TileEntityBase()
  {
    ...
    {
      ModUtil.LOGGER.info("Created Energy Sharing Provider");
